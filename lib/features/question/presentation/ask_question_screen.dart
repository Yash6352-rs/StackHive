...
import 'package:stackhive/services/ai_service.dart';
...
class _AskQuestionScreenState extends ConsumerState<AskQuestionScreen> {
  ...
  Future<void> _submitQuestion() async {
    ...
    try {
      ...
      unawaited(
        () async {
          final aiAnswer = await AiService.generateAnswer(
          ...
          if (aiAnswer != null && aiAnswer.isNotEmpty) {
            await ref.read(answerRepositoryProvider).addAiAnswer(
              questionId: questionId,
              content: aiAnswer,
            );
          }
                    ...
                    children: [
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                            hintText:
                                'e.g. How to fix Flutter layout overflow?',
